...
<div id="add-rooms-modal" tabindex="-1" aria-hidden="true" class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 w-full md:inset-0 h-modal md:h-full">
  <div class="relative p-4 w-full h-full md:h-auto">
    ...
    <div class="w-full md:w-3/5 mx-auto relative bg-white rounded-lg shadow">
      <button id="btn-colse-model" type="button" class="absolute top-3 right-2.5 text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center dark:hover:bg-gray-800 dark:hover:text-white" data-modal-toggle="add-rooms-modal">
      ...
      <div class="py-6 px-6 lg:px-8">
        ...
        <form id="addRoomForm" class="space-y-6" action="javascript:addRoom()" method="post" enctype="multipart/form-data">
              ...
              <div class="space-y-1 text-center">
                ...
                <div class="flex text-sm text-gray-600">
                  <label for="file-upload" class="relative cursor-pointer bg-white rounded-md font-medium text-indigo-600 hover:text-indigo-500 focus-within:outline-none focus-within:ring-2 focus-within:ring-offset-2 focus-within:ring-indigo-500">
                    ...
                    <input id="file-upload" name="file-upload" multiple accept="image/*" type="file" class="sr-only">
                  </label>
          ...
          <div id="ImagesAddRoom" class="flex mt-2 overflow-x-auto">
          </div>
